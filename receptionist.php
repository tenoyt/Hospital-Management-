            ...
            <div class="card-container">
                ...
                <div class="card bg-success text-white">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            <!-- Event Content -->
                            1. <strong>Upcoming Meetings:</strong> Monthly Staff Meeting - 25th November, 2023 at 11:00 AM. Location: Conference Room.
                            <br><br>
                            2. <strong>Training Sessions:</strong> Customer Service Training - 26th November, 2023 from 10:00 AM to 11:00 AM. All staff members are required to attend.
                            <br><br>
                            3. <strong>Celebrations and Recognitions:</strong> Employee of the Month Celebration - Join us in congratulating Andrew on their outstanding performance.
                            <br><br>
                        </p>
                    </div>
                </div>
