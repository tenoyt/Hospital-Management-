...
<div class="container">
    <div class="flex-container">
        <div class="sidebar">
            ...
            <div id="main">
                <a href="display_patient_information.php">Display Patient Information</a>
                <a href="patient_report.php">Patient Report</a>
                <a href="lab_report.php">Lab Report</a>
                <a href="app_physician.php">Appointment</a>
            ...
            <div class="card-container">
                ...
                <div class="card bg-success text-white">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            <!-- Event Content -->
                            1. <strong>Upcoming Meetings:</strong> Monthly Staff Meeting - 25th November, 2023 at 10:00 AM. Location: Meeting Room 2.
                            <br><br>
                            2. <strong>Training Sessions:</strong> Customer Service Training - 26th November, 2023 from 9:00 AM to 10:00 AM. All staff members are required to attend.
                            <br><br>
                            3. <strong>Celebrations and Recognitions:</strong> Employee of the Month Celebration - Join us in congratulating John on their outstanding performance.
                            <br><br>
                        </p>
                    </div>
                </div>
